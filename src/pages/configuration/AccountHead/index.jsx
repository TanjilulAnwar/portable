...
const columns = [
  ...
  { key: 'ac_head_id', title: 'Head Code', isResizable: true, style:{...row, width: 120}},
  { key: 'ac_group_name', title: 'Group', style:{...row}},
                ...
                filterRowCell: {
                  content: (props) => {
                    switch(props.column.key){
                      ...
                      case 'action': return <PrintButton url="/print/accountgroups"/>
                      default: return
                    }
                  }
                },
