...
class PurchaseHistory extends React.PureComponent{
  ...
  handleSearch = (by, value)=>{
    ...
    this.setState({searching: true, history_list: [], search_data: value})
    ...
    return(
      <div className="app-wrapper">
        ...
        {this.state.history_list.length > 0 &&
          <HistoryTable history_list={this.state.history_list} history_type="Purchase" search_data={this.state.search_data}/>
        }
      </div>
    )
  }
